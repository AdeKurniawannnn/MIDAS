...
- main:
  ...
  - main:
    ...
    - heading "Our Core Solutions" [level=2]
    - paragraph: Discover how our comprehensive suite of services can transform your digital presence
    - tablist:
      - tab "Digital Automation" [selected]:
        - img
        - text: Digital Automation
    ...
    - tabpanel "Digital Automation":
      - img
      - heading "Digital Automation" [level=3]
      - paragraph: Streamline your business processes with our cutting-edge automation solutions that save time and reduce errors.
      - heading "Key Benefits:" [level=4]
      - list:
        - listitem:
          - img
          - text: Reduce manual tasks by up to 80%
        - listitem:
          - img
          - text: Improve data accuracy and consistency
        - listitem:
          - img
          - text: Scale operations without increasing headcount
        - listitem:
          - img
          - text: Gain real-time insights into business processes
      - img
      - text: Digital
